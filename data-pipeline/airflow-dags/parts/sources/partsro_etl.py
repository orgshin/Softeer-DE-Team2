...
from fetchers.parts.partsro_fetcher import run_downloader
...
# 1. 상수 정의
CONFIG_FILE_PATH = "/opt/airflow/config/parts/sources/partsro.yaml"
...
# 4. DAG 정의
with DAG(
    dag_id="parts_source_partsro_etl_pipeline",
    start_date=pendulum.datetime(2025, 8, 1, tz="Asia/Seoul"),
    schedule=None, catchup=False, tags=["parts", "source", "partsro"], default_args=default_args,
    doc_md="Partsro 부품 정보를 수집하고 Spark로 파싱하여 S3에 Parquet으로 저장합니다."
) as dag:
    # 5. 태스크 정의
    ...
    # 6. 워크플로우 명시
    start >> fetch_html_task >> parse_html_task >> end